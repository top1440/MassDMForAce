...
to_print_disclaimer = [f"{Fore.LIGHTWHITE_EX}{Style.BRIGHT}DISCLAIMER:",
                       f"{Style.RESET_ALL}{Fore.LIGHTWHITE_EX}User automation and spamming are {Fore.LIGHTYELLOW_EX}{Style.BRIGHT}against Discord's TOS!! BUT PLEASE KEEP DOING IT {Style.RESET_ALL}{Fore.RESET}",
                       f"{Fore.LIGHTWHITE_EX}USE THIS TOOL FOR ANYTHING TAKE THE RISK",
...
boot_anim = [f"{Style.BRIGHT}{Fore.LIGHTWHITE_EX}Booting {Fore.RED} {Fore.RESET}{Fore.LIGHTWHITE_EX}Aces MASS DMMMMMMMMMMMM HAHAHHHAHAHA",
             f"{Fore.RED}TARTINGGGGGGGGGGGGG%",
             f"{Fore.YELLOW}GETTING CLOSER%",
             f"{Fore.LIGHTYELLOW_EX}ALMOST THEREE",
             f"{Fore.LIGHTGREEN_EX}SIKEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEeeeeeeee%",
             f"{Fore.LIGHTBLUE_EX}GET BEAMED jk Top a W"]
if not boot:
...
async def massdm():
        ...
        input(f"\n{Fore.WHITE}Thanks for using {Fore.YELLOW}\nPress Enter to return to the main menu")
        return await main()
...
async def exit():
        await client.close()
        input(f"{Fore.WHITE}Thanks for using {Fore.YELLOW}\nPress Enter 5 times to close the program.")
...
async def main():
    ...
    print(pyfade.Fade.Horizontal(pyfade.Colors.yellow_to_red, f'''
    ...
    {Fore.BLUE}      ██║   ╚█████╔╝██║     ██║        ██║     {Fore.RED}  ╚██╔╝ ╚██╔╝ ╚█████╔╝ ██║     ██║        ██║
    {Fore.BLUE}      ╚═╝    ╚════╝ ╚═╝     ╚═╝        ╚═╝     {Fore.RED}   ╚═╝   ╚═╝   ╚════╝  ╚═╝     ╚═╝        ╚═╝
                                    {Fore.BLUE}     !!Aces   {Fore.RED}   MassDm!!'''))
    print(f'''
{Fore.LIGHTWHITE_EX}                                   Made by {Fore.YELLOW}Top ( cough cough I made this all by my self mhm mhm cough cough ) 
{Fore.LIGHTWHITE_EX}If you need any support on this tool check out {Fore.LIGHTBLUE_EX}https://discord.gg/steal          
...
{Connected}
{Fore.BLUE}[0] {Fore.RED}Nuke
{Fore.BLUE}[1] {Fore.RED}Raid                | {Fore.BLUE}[2] {Fore.RED}Mass Dm Client Users  | {Fore.BLUE}[3] {Fore.RED}Mass Embed Dm Client Users
{Fore.BLUE}[4] {Fore.RED}Leave all Servers   | {Fore.BLUE}[5] {Fore.RED}Mass Dm               | {Fore.BLUE}[6] {Fore.RED}Mass Embed Dm
{Fore.BLUE}[7] {Fore.RED}Display all Servers | {Fore.BLUE}[8] {Fore.RED}Mass Dm friends       | {Fore.BLUE}[9] {Fore.RED}Mass Embed Dm friends
{Fore.BLUE}[10] {Fore.RED}Give Admin to @everyone
{Fore.BLUE}[11] {Fore.RED}Unban every banned Member
{Fore.BLUE}[quit] {Fore.RED}Exit Script
''')
...
def start():
    @client.event
    async def on_ready():
        await client.change_presence(activity=discord.Streaming(name='.gg/leveing', url='https://www.twitch.tv/top'))
        os.system('cls' if os.name == 'nt' else 'clear')
        return await main()
